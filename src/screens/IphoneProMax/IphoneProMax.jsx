      ...
      <div className="iphone-pro-max">
          ...
          <div className="overlap-3">
            ...
            <div className="element-2">
              <div className="overlap-group-2">
                ...
                <img className="element-4" alt="Element" src="/img/1.svg" />
        ...
        <div className="overlap-5">
          ...
          <div className="group-4">
            ...
            <ElementPartlyCloudy className="thirty-two-partly-cloudy" color="on" outline="/img/outline-17.svg" />
            <ElementPartlyCloudy className="element-partly-cloudy-instance" color="on" outline="/img/outline-15.svg" />
            <ElementPartlyCloudy className="thirty-two-partly-cloudy-instance" color="on" outline="/img/outline-13.svg" />
            <ElementPartlyCloudy className="design-component-instance-node" color="on" outline="/img/outline-11.svg" />
            <ElementCloudyClearAt
                className="thirty-two-cloudy-clear-at-times"
                color="on"
                img="/img/union-4.svg"
                union="/img/union-6.svg"
                union1="/img/union-2.svg"
                union2="/img/union.svg"
            />
            <ElementSunny className="thirty-two-sunny-instance" color="on" outline="/img/outline-9.svg" />
            <ElementSunny className="element-sunny-2" color="on" outline="/img/outline-7.svg" />
            ...
            <Group className="group-172" subtract="/img/subtract.svg" />
            <Group className="group-instance" subtract="/img/subtract-16.svg" />
            <Group className="group-172-instance" subtract="/img/subtract.svg" />
            <Group className="group-5" subtract="/img/subtract-16.svg" />
            <Group className="group-6" subtract="/img/subtract.svg" />
            <Group className="group-7" subtract="/img/subtract.svg" />
          </div>
        </div>
        <GroupWrapper className="group-157" colorOnWrapperOutline="/img/outline-27.svg" />
        <GroupWrapper
            className="group-157-instance"
            colorOnWrapperOutline="/img/outline-25.svg"
            text="TUE"
            text1="17°"
            text2="23°"
        />
        <GroupWrapper
            className="group-8"
            colorOnWrapperOutline="/img/outline-23.svg"
            text="WED"
            text1="20°"
            text2="25°"
        />
        <GroupWrapper
            className="group-9"
            colorOnWrapperOutline="/img/outline-21.svg"
            text="SUN"
            text1="15°"
            text2="22°"
        />
        ...
        <GroupWrapper
            className="group-11"
            colorOnWrapperOutline="/img/outline-19.svg"
            text="FRI"
            text1="21°"
            text2="29°"
        />
        <img className="doc" alt="Doc" src="/img/doc-icont2-2.png" />
      </div>
  );
};
